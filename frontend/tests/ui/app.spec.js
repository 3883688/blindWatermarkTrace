  ...
  if (url.pathname === '/api/images') {
    return {
      items: [{
        ...
        mode: 'dct', created_at: '2026-07-17', status: '保护中', confidence: 98,
      }],
...
test('Vue shell retains existing workflow labels across desktop and mobile', async ({ page }) => {
  ...
  await page.getByPlaceholder('https://example.com/photo.jpg 或 /uploads/...').fill('https://example.com/source.jpg');
  await page.getByRole('button', { name: '开始溯源' }).click();
